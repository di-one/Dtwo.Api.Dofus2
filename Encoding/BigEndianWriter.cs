...
namespace Dtwo.API.Dofus2.Encoding
{
    public class BigEndianWriter : IDataWriter, IDisposable
    {
        ...
        {
            m_writer = new BinaryWriter(new MemoryStream(), System.Text.Encoding.UTF8);
        }
        ...
        {
            m_writer = new BinaryWriter(stream, System.Text.Encoding.UTF8);
        }
        ...
        public void WriteVarShort(int param)
        {
            WriteVarShort((short)param);
        }

        public void WriteVarLong(double param)
        {
            WriteVarLong((long)param);
        }

        public void WriteFloat(double param)
        {
